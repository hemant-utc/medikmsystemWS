...
public class RolesDAO extends BaseHibernateDAO {
	...
	public Roles findById(java.lang.Long id) {
		...
		try {
			Roles instance = (Roles) getSession().get("com.medikm.dto.Roles", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Roles instance) {
		...
		try {
			List results = getSession().createCriteria("com.medikm.dto.Roles").add(Example.create(instance)).list();
