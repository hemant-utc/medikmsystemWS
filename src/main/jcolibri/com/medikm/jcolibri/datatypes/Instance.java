 ...
 * 11/01/2007
 */
package com.medikm.jcolibri.datatypes;
 ...
 * For example: In the gaia.fdi.ucm.es/ontologies/Restaurant.owl ontology, the
 * long name of the concept "wine" is
 * "gaia.fdi.ucm.es/ontologies/Restaurant.owl#wine. The short name is just
 * "wine" or "restaurant:wine" if "restaurant" is a defined prefix for that
 * ontology.
 * 
 * @author Juan A. Recio-Garc�a.
 * @version 2.0
...
public class Instance implements TypeAdaptor {
	...
	/**
	 * Creates an Instance looking for the instance in the ontology with the
	 * same name.
	 * <p>
	 * The useShortName param allows using short or long names. For example:<br>
	 * In the gaia.fdi.ucm.es/ontologies/Restaurant.owl ontology, the long name
	 * of the concept "wine" is "gaia.fdi.ucm.es/ontologies/Restaurant.owl#wine.
	 * The short name is just "wine" or "restaurant:wine" if "restaurant" is a
	 * defined prefix for that ontology.
	 * 
	 * @param instance
	...
	/**
	 * Creates an instance connected with the instance in the ontology. It uses
	 * a short name format.
	 * 
	 * @param instance
	 *            Name of the concept in the ontology
	...
	public void fromString(String content) throws OntologyAccessException {
		...
		if (!OntoBridgeSingleton.getOntoBridge().existsInstance(name))
			throw new jcolibri.exception.OntologyAccessException(
					"Instance: " + name + " not found in loaded ontologies. Check names or OntoBridge configuration.");
	}
