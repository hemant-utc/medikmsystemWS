...
public class DirectAttributeCopyMethod {
	...
	public static void copyAttribute(Attribute querySource, Attribute caseDestination, CBRQuery query,
		...
		Object queryValue = com.medikm.jcolibri.util.AttributeUtils.findValue(querySource, query);
		try {

			for (CBRCase c : cases) {
				CaseComponent cc = com.medikm.jcolibri.util.AttributeUtils.findBelongingComponent(caseDestination, c);
