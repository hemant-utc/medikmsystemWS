...
import com.medikm.jcolibri.method.maintenance.solvesFunctions.ICFSolvesFunction;
...
public class ICFRedundancyRemoval extends AbstractCaseBaseEditMethod {
	...
	{	/* ICF Algorithm:
		 ...
		 * Return T
		 */
		com.medikm.jcolibri.util.ProgressController.init(this.getClass(),"ICF Redundancy Removal",com.medikm.jcolibri.util.ProgressController.UNKNOWN_STEPS);
