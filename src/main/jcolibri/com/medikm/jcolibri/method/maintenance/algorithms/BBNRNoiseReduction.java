...
public class BBNRNoiseReduction extends AbstractCaseBaseEditMethod {
	...
	{	/*
		...
		com.medikm.jcolibri.util.ProgressController.init(this.getClass(), "Blame-based Noise Reduction (BBNR)", com.medikm.jcolibri.util.ProgressController.UNKNOWN_STEPS);
