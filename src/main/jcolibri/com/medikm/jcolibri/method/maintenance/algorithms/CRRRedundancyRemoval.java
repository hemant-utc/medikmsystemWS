...
import com.medikm.jcolibri.method.maintenance.CaseResult;
...
public class CRRRedundancyRemoval extends AbstractCaseBaseEditMethod {
	...
	{	/*
		 ...
		 * Return TSet
		 */
		com.medikm.jcolibri.util.ProgressController.init(this.getClass(), "Conservative Redundancy Removal(CRR)", com.medikm.jcolibri.util.ProgressController.UNKNOWN_STEPS);
