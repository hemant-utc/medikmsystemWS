...
public class QueryResult implements Comparable {
	 ...
	 */
	/*
	 * @SuppressWarnings("unchecked") public static List sortResults(boolean
	 * ascending, List<QueryResult> toSort) { Collections.sort(toSort);
	 * if(ascending) { return toSort; } List<QueryResult> sorted = new
	 * LinkedList<QueryResult>(); for(QueryResult res: toSort) { sorted.add(0,
	 * res); } return sorted; }
	 */
}