...
public class MaxString implements LocalSimilarityFunction {
	 ...
	 */
	public double compute(Object s, Object t)
			throws com.medikm.jcolibri.exception.NoApplicableSimilarityFunctionException {
		if ((s == null) || (t == null))
			return 0;
		if (!(s instanceof java.lang.String))
			throw new com.medikm.jcolibri.exception.NoApplicableSimilarityFunctionException(this.getClass(),
					s.getClass());
		...
		if (news.equals(newt))
			...
			return ((double) MaxSubString(news, newt) / (double) Math.max(news.length(), newt.length()));
	}
