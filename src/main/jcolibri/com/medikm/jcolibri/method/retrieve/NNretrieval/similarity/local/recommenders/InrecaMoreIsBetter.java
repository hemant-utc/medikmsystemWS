package com.medikm.jcolibri.method.retrieve.NNretrieval.similarity.local.recommenders;

import com.medikm.jcolibri.exception.NoApplicableSimilarityFunctionException;
...
public class InrecaMoreIsBetter implements LocalSimilarityFunction {
	...
	public double compute(Object caseObject, Object queryObject) throws NoApplicableSimilarityFunctionException {
		...
		if (caseValue >= queryValue)
			...
			return jump * (1 - ((queryValue - caseValue) / queryValue));
