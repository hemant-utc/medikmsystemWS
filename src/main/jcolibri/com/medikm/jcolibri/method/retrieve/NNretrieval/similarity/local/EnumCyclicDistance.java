package com.medikm.jcolibri.method.retrieve.NNretrieval.similarity.local;



import com.medikm.jcolibri.method.retrieve.NNretrieval.similarity.LocalSimilarityFunction;
...
public class EnumCyclicDistance implements LocalSimilarityFunction {
	 ...
	 */
	public double compute(Object o1, Object o2) throws com.medikm.jcolibri.exception.NoApplicableSimilarityFunctionException{
		if ((o1 == null) || (o2 == null))
			return 0;
		if(!(o1 instanceof Enum))
			throw new com.medikm.jcolibri.exception.NoApplicableSimilarityFunctionException(this.getClass(), o1.getClass());
		if(!(o2 instanceof Enum))
			throw new com.medikm.jcolibri.exception.NoApplicableSimilarityFunctionException(this.getClass(), o2.getClass());
