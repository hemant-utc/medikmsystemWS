...
/**
 * Predicate that compares if the query object is less or equal than the case
 * object. Only applicable to enums and numbers.
 * 
...
public class QueryLessOrEqual implements FilterPredicate {
	...
	public boolean compute(Object caseObject, Object queryObject) throws NoApplicableFilterPredicateException {
		if ((caseObject == null) && (queryObject == null))
			...
			throw new com.medikm.jcolibri.exception.NoApplicableFilterPredicateException(this.getClass(),
					caseObject.getClass());
