 ...
 * 23/07/2007
 */
package com.medikm.jcolibri.extensions.maintenance_evaluation.evaluators;
...
import com.medikm.jcolibri.extensions.maintenance_evaluation.MaintenanceEvaluator;
...
public class MaintenanceHoldOutEvaluator extends MaintenanceEvaluator {
	...
	protected void prepareCases(Collection<CBRCase> originalCases, List<CBRCase> querySet, int testPercent,
		...
		if (this.simConfig != null && this.editMethod != null) { // Perform
																	// maintenance
																	// on this
																	// case base
