 ...
 * 05/01/2007
 */
package com.medikm.jcolibri.cbrcore;
...
public interface CBRCaseBase {
	 ...
	 *
	 */
	public void init(Connector connector) throws com.medikm.jcolibri.exception.InitializingException;

	public void init(Connector connector, String condition) throws com.medikm.jcolibri.exception.InitializingException;
