...
/**
 * TbDiscussionForum entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings({ "rawtypes", "serial" })
public class TbDiscussionForum implements java.io.Serializable {
	...
	/** minimal constructor */
	public TbDiscussionForum(Case1 case1, Episode episode) {
		this.case1 = case1;
		this.episode = episode;
	}

	/** full constructor */
	public TbDiscussionForum(CcbrQuestion ccbrQuestion, Case1 case1, Episode episode, Timestamp discussionDt,
			...
			String optionsConsidered, Timestamp discussionEndTime, String status, Set recommendedPlanLikes,
			Set tbDiscussionForumQuestions, Set tbDiscussionForumAnsweres) {
