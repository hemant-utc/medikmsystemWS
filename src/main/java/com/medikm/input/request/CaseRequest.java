 ...
 * 
 */
@ApiModel(value = "Case Request", description = "Case Request")
@XmlRootElement(name = "caseRequest")
public class CaseRequest {
	...
	@ApiModelProperty(value = "Disease Sub Type", notes = "Disease Sub Type", dataType = "Integer")
	 ...
	 */
	@ApiModelProperty(value = "Primary Diagnosis Dt", notes = "Primary Diagnosis Dt", dataType = "Date")
	 ...
	 * @return the dtDeath
	 */
	@ApiModelProperty(value = "Dt Death", notes = "Dt Death", dataType = "Date")
	 ...
	 */
	@ApiModelProperty(value = "Duration Of Symptoms Mon", notes = "Duration Of SymptomsMon", dataType = "Integer")
	 ...
	 */
	@ApiModelProperty(value = "Seen On Bonescan", notes = "Seen On Bone Scan", dataType = "Integer")
	 ...
	 */
	@ApiModelProperty(value = "Separate T Node In Same Lobe", notes = "Separate T Node In Same Lobe", dataType = "Integer")
	 ...
	 */
	@ApiModelProperty(value = "Interval Debulking Dt", notes = "Interval Debulking Dt", dataType = "Date")
	 ...
	 */
	@ApiModelProperty(value = "Esophageal C Staging Method", notes = "Esophageal C Staging Method")
	 ...
	 */
	@ApiModelProperty(value = "Rad Onc Physicia", notes = "Rad Onc Physicia", dataType = "Integer")
	 ...
	 */
	@ApiModelProperty(value = "Cancer Sub Type", notes = "Cancer Sub Type", dataType = "int")
	 ...
	 */
	@ApiModelProperty(value = "Cancer Type", notes = "Cancer Type", dataType = "int")
	 ...
	 * @return the patient
	 */
	@ApiModelProperty(value = "Patient Id", notes = "Patien tId", dataType = "Integer")
	 ...
	 * @return the wt
	 */
	@ApiModelProperty(value = "Wt", notes = "Wt")
	public Short getWt() {
		return wt;
	}
	 ...
	 * @return the dist
	 */
	@ApiModelProperty(value = "Dis", notes = "Dis", dataType = "String")
	 ...
	 */
	@ApiModelProperty(value = "GynOncologist Id", notes = "GynOncologist Id", dataType = "Integer")
	...
	@ApiModelProperty(value = "Surgical Spill", notes = "Surgical Spill")
	...
	@ApiModelProperty(value = "Operable", notes = "Operable", dataType = "String")
	...
	@ApiModelProperty(value = "Residual Disease", notes = "Residual Disease")
	...
	@ApiModelProperty(value = "Number Of Metastatic Sites", notes = "Number Of MetastaticS ites", dataType = "Integer")
	...
	@ApiModelProperty(value = "Location Id", notes = "Location Id", dataType = "Integer")
	...
	@ApiModelProperty(value = "Seminal Vesicle Invasion", notes = "Semina lVesicle Invasion")
	...
	@ApiModelProperty(value = "Tumor In Centra lLocation", notes = "Tumor In Central Location")
	...
	@ApiModelProperty(value = "Righ tMid Lateral", notes = "Right Mid Lateral", dataType = "String")
	...
	@ApiModelProperty(value = "SeminalV Invasion Percentage", notes = "SeminalV InvasionPercentage", dataType = "Float")
	...
	@ApiModelProperty(value = "Biopsy Gleason Score", notes = "Biopsy GleasonS core", dataType = "String")
	...
	@ApiModelProperty(value = "Number Of Positive Cores", notes = "Number Of Positive Cores", dataType = "Integer")
	...
	@ApiModelProperty(value = "Psa Levels", notes = "", dataType = "Float")
	...
	@ApiModelProperty(value = "Progression Free Survival Probability After Salvage Rt Six Y", notes = "Progression Free Survival Probability After Salvage Rt Six Y", dataType = "String")
	...
	@ApiModelProperty(value = "Progression Free Survival After Bt", notes = "Progression Free Survival After Bt", dataType = "String")
	...
	@ApiModelProperty(value = "Case Status", notes = "Case Status", dataType = "String")
	 ...
	 */
	@ApiModelProperty(value = "Created By", notes = "Created By")
	 ...
	 */
	@ApiModelProperty(value = "Last Update dBy", notes = "Last Updated By")
